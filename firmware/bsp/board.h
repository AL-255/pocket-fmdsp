...
void board_audio_restart(void);         /* reset ring/DMA/counters (song switch), keep codec */
uint32_t board_sd_read_errors(void);    /* cumulative SD blocks that failed all retries */
